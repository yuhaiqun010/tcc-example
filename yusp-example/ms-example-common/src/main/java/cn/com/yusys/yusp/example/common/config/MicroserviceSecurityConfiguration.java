...
import cn.com.yusys.yusp.commons.security.AuthoritiesConstants;
...
public class MicroserviceSecurityConfiguration extends ResourceServerConfigurerAdapter {
    ...
    private String getKeyFromAuthorizationServer(RestTemplate keyUriRestTemplate) {
        ...
        return (String) keyUriRestTemplate
                .exchange("http://uaa/oauth/token_key", HttpMethod.GET, request, Map.class).getBody().get("value");
    ...
    void destory(){
    	if(discoveryClient instanceof EurekaDiscoveryClient){
    		DiscoveryClient discoveryClientT = (EurekaDiscoveryClient) discoveryClient;
    		//discoveryClientT.
    	}
        System.out.println("bean1 is destory");
    }
}
